...
! Synopsis  : Unit tests for m_sha1
!
...
!---Public/Private declarations-------------------------------------------------
  ...
  public unit_m_sha1_suite_before
  public unit_m_sha1_suite_after

  public unit_m_sha1_test_001
  public unit_m_sha1_before_001
  public unit_m_sha1_after_001

  public unit_m_sha1_test_002
  public unit_m_sha1_before_002
  public unit_m_sha1_after_002

  public unit_m_sha1_test_003
  public unit_m_sha1_before_003
  public unit_m_sha1_after_003

  public unit_m_sha1_test_004
  public unit_m_sha1_before_004
  public unit_m_sha1_after_004
...
!---End of public/private declarations------------------------------------------
  ...
  character(len=*), parameter :: module = 'm_sha1'
...
! Type to host ISTCAVP reference test cases
  type t_nist_cavp
    ...
    integer(kind=1), dimension(20) :: hash
  end type t_nist_cavp
  type(t_nist_cavp), dimension(:), allocatable, save :: nist_cavp
  
! File names
  character(len=32), save :: Sha1ShortMsg = "SHA1ShortMsg.rsp"
  character(len=32), save :: Sha1LongMsg = "SHA1LongMsg.rsp"
...
subroutine unit_m_sha1_before_001( ut )

! The unit test
  class(t_xfunit_unit), intent(inout) :: ut

  
end subroutine unit_m_sha1_before_001

! ############################################################################

subroutine unit_m_sha1_test_001( ut )
...
end subroutine unit_m_sha1_test_001

! ############################################################################

subroutine unit_m_sha1_after_001( ut )
...
end subroutine unit_m_sha1_after_001

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_sha1_before_002( ut )
...
end subroutine unit_m_sha1_before_002

! ############################################################################

subroutine unit_m_sha1_test_002( ut )
...
end subroutine unit_m_sha1_test_002

! ############################################################################

subroutine unit_m_sha1_after_002( ut )
...
end subroutine unit_m_sha1_after_002

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_sha1_before_003( ut )
...
end subroutine unit_m_sha1_before_003

! ############################################################################

subroutine unit_m_sha1_test_003( ut )
...
end subroutine unit_m_sha1_test_003

! ############################################################################

subroutine unit_m_sha1_after_003( ut )
...
end subroutine unit_m_sha1_after_003
...
subroutine unit_m_sha1_before_004( ut )
...
end subroutine unit_m_sha1_before_004

! ############################################################################

subroutine unit_m_sha1_test_004( ut )
...
! Compute file hash
  ...
  call ut%assert_equal( "File hash", &
                        bytes_to_hex(bytes,.true.), &
                        '8a09d3ed16ff46054e6b78eb840f1097de192ac6' )
  deallocate(bytes)
                        
end subroutine unit_m_sha1_test_004

! ############################################################################

subroutine unit_m_sha1_after_004( ut )
...
end subroutine unit_m_sha1_after_004
...
subroutine unit_m_sha1_suite_before( suite )

! Reference suite
  class(t_xfunit_suite), intent(inout) :: suite


end subroutine unit_m_sha1_suite_before

! ############################################################################
! # Suite after procedure ####################################################
! ############################################################################

subroutine unit_m_sha1_suite_after( suite )

! Reference suite
  class(t_xfunit_suite), intent(inout) :: suite
  

end subroutine unit_m_sha1_suite_after
