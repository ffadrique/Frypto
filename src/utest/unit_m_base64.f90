...
! Synopsis  : Unit tests driver for m_base64
!
...
! Initialise test suite
  suite = xfunit_suite( package=package, &
                        source='m_base64.f03', &
                        annotation='Data encoding as base64' )

! Create test
  ut = xfunit_unit( name='unit_m_base64_test_001', &
                    classname='t_base64', &
                    executer=unit_m_base64_test_001, &
                    annotation='Encoding' )
  call suite%add_unit_test( ut )

! Create test
  ut = xfunit_unit( name='unit_m_base64_test_002', &
                    classname='t_base64', &
                    executer=unit_m_base64_test_002, &
                    annotation='Decoding' )
  call suite%add_unit_test( ut )

! Create test
  ut = xfunit_unit( name='unit_m_base64_test_003', &
                    classname='t_base64', &
                    executer=unit_m_base64_test_003, &
                    annotation='Encoding (no padding)' )
  call suite%add_unit_test( ut )

! Create test
  ut = xfunit_unit( name='unit_m_base64_test_004', &
                    classname='t_base64', &
                    executer=unit_m_base64_test_004, &
